<div id="vendorDetailsTab" class="tab-pane fade p-2" id="v-pills-vendor" role="tabpanel" aria-labelledby="v-pills-vendor-tab">
...
<div  id="vendorListTab" class="container-fluid tab-pane fade active show">
   ...
   <div class="tab-content">
   		<div id="vendorSearchTab" class="container-fluid tab-pane fade active p-0 show">
			<br>
