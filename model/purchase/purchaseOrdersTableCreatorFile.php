<?php
	...
	$purchaseDetailsSearchSql = " SELECT po.*,
            ...
            ELSE ''
        END AS statusText,
	v.companyName as fullName FROM purchaseorder po inner join vendor v on po.vendorID=v.vendorID where isDeleted = false ORDER BY po.purchaseID DESC LIMIT 1,10";
