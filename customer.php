<div id="customerDetailsTab" class="tab-pane fade p-2" id="v-pills-customer" role="tabpanel" aria-labelledby="v-pills-customer-tab">
...
<div  id="customerListTab" class="container-fluid tab-pane fade active show">
   ...
   <div class="tab-content">
      <div id="customerSearchTab" class="container-fluid tab-pane fade active p-0 show">
         <br>
