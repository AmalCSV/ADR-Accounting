            ...
            <div class="row">
                <div class="col-lg-2">
                    ...
                    <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                        <a class="nav-link" href="items.php" role="tab" aria-controls="v-pills-item" aria-selected="true">Item</a>
                        <a class="nav-link active" href="purchase.php" id="v-pills-purchase-tab" onload="initPurchaseOrder()" role="tab" aria-selected="true">Purchase</a>
